...
const projectsData = {
  intro: {
    ...
    subtitle:
      'A few recent driveway, patio, and repair jobs from the neighborhoods we serve.'
  },
  projects: [
    {
...
export default function Projects() {
  ...
  return (
    <div className="mz-page">
      ...
      {/* 7.3 Simple & Efficient Process (screenshot layout) */}
